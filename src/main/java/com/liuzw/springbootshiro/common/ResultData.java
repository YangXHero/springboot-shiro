...
public class ResultData<T> implements Serializable {
     ...
     * @return         ResultData
     */
    public static <E> ResultData<E> createAuthErrorResult() {
        return createAuthErrorResult(ResultDataConstants.MSG_AUTH_ERROR);
    }
     ...
     * @return         ResultData
     */
    public static <E> ResultData<E> createAuthErrorResult(String message) {
        if (StringUtils.isEmpty(message)) {
            message = ResultDataConstants.MSG_AUTH_ERROR;
        }
        return new ResultData<>(ResultDataConstants.CODE_AUTH_ERROR, message, null);
    }
